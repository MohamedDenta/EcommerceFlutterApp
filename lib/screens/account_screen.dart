...
class _AccountScreenState extends State<AccountScreen> {
  ...
  _launchURL() async {
    const url = 'https://en.wikipedia.org/wiki/Help:URL';
  ...
  Future<void> pickImage() async {
    final userBloc = Provider.of<FirebaseProvider>(context, listen: false);
    ...
    if (pickedImg != null) {
      setState(() {
        ...
        userBloc.updateUser(User(
            name: userBloc.user.name, email: userBloc.user.email, avatar: ''));
      });
    }
  }
}
